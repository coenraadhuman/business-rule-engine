...
public class TestValidationImmediateInvalidRule extends ValidationRule<TestResponse, TestArgument> {
    ...
    protected EngineResult<TestResponse> executeRule(final TestArgument argument) {
        return new EngineResultBuilder<TestResponse>()
            ...
            .ruleResult(TestResponse.TEST_VALIDATION_IMMEDIATE_INVALID_RULE)
            .build();
    }
}
