...
public class TestValidationInfoProviderRule extends ValidationRule<TestResponse, TestArgument> {
    ...
    protected EngineResult<TestResponse> executeRule(final TestArgument argument) {
        return new EngineResultBuilder<TestResponse>()
            ...
            .ruleResult(TestResponse.TEST_VALIDATION_PROVIDER_VALID_RULE)
            .message("")
            .build();
    }
}
